...
public class RandomGenerator {
	...
	public void test() {
		...
		for(int i =0; i< 100; i++){
			...
			String stringDate = dayOfWeek + ", " + dayOfMonth + " " + monthOfYear + " " + year + " 11:05:30 GMT";//, dayOfWeek, dayOfMonth, monthOfYear, year);
			CharSequence datecs = stringDate;
			TemporalAccessor parsedDate = DateTimeFormatter.RFC_1123_DATE_TIME.parse(datecs);
